...
namespace WebAPI.ViewModels.AccountViewModels
{
    ...
    {
        private readonly LazyDependency<IAccountManagementService> _accountAuthenticationService =
        ...
        public IAccountManagementService AccountAuthenticationService => _accountAuthenticationService.Value;
