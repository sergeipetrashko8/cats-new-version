...
{
    //todo # [PasswordRequiredIfResetAttribute]
    public class ModifyLecturerViewModel
    {
        ...
        [Display(Name = "Сбросить пароль")] public bool IsPasswordReset { get; set; }
        ...
        [Display(Name =
            "Для выбора группы секретаря нажмите левой кнопкой мыши по соответствующему элементу в левом списке:")]
