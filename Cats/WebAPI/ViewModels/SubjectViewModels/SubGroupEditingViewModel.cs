...
namespace WebAPI.ViewModels.SubjectViewModels
{
    public class SubGroupEditingViewModel
    {
        ...
        public SubGroupEditingViewModel(int subjectId, int groupId = 0)
        {
            ...
            if (groupId == 0) groupId = int.Parse(GroupsList.FirstOrDefault().Value);
            ...
            else
            {
                ...
                StudentGroupList = groups.FirstOrDefault(e => e.Id == groupId).Students
                    .Where(e => e.Confirmed == null || e.Confirmed.Value).Select(e => new SelectListItem
                    {
                        Text = e.FullName,
        ...
        public List<SelectListItem> SubGroupsFirstList { get; set; }

        public List<SelectListItem> SubGroupsTwoList { get; set; }

        public List<SelectListItem> SubGroupsThirdList { get; set; }
        ...
        private void FillSubGroupsList(IEnumerable<SubGroup> subGroups)
        {
            ...
            SubGroupsFirstList = subGroups.FirstOrDefault(e => e.Name == "first").SubjectStudents
                .Where(e => e.Student.Confirmed == null || e.Student.Confirmed.Value).Select(e => new SelectListItem
                {
            ...
            SubGroupsTwoList = subGroups.FirstOrDefault(e => e.Name == "second").SubjectStudents
                .Where(e => e.Student.Confirmed == null || e.Student.Confirmed.Value).Select(e => new SelectListItem
                {
                    Text = e.Student.FullName,
                    Value = e.Student.Id.ToString(CultureInfo.InvariantCulture),
            ...
            SubGroupsThirdList = subGroups.FirstOrDefault(e => e.Name == "third").SubjectStudents
                .Where(e => e.Student.Confirmed == null || e.Student.Confirmed.Value).Select(e => new SelectListItem
                {
                    Text = e.Student.FullName,
                    Value = e.Student.Id.ToString(CultureInfo.InvariantCulture),
