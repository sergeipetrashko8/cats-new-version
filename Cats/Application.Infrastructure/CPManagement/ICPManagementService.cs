...
namespace Application.Infrastructure.CPManagement
{
    public interface ICPManagementService
    {
        ...
        PagedList<StudentData> GetGraduateStudentsForUser(int userId, int subjectId, GetPagedListParams parms,
            bool getBySecretaryForStudent = true);

        PagedList<StudentData> GetGraduateStudentsForGroup(int userId, int groupId, int subjectId,
