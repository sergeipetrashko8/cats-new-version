...
namespace Application.Infrastructure.FilesManagement
{
    public class AttachedFile
    {
        ...
        public AttachedFile(string displayName, string guid, FileInfo fileInfo, int id, string deleteType)
        {
            SetValues(displayName, guid, fileInfo, (int) fileInfo.Length, fileInfo.FullName, id, deleteType);
        }

        public AttachedFile(string displayName, string guid, FileInfo fileName, int fileLength, string fullPath,
            string deleteType)
        {
        ...
        private void SetValues(string displayName, string guid, FileInfo fileName, int fileLength, string fullPath,
            int id, string deleteType)
        {
            IdFile = id;
            Name = displayName;
            Size = fileLength;
