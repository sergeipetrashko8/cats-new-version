...
namespace LMP.PlagiarismNet.Utils
{
    ...
    public sealed class AtomicInteger
    {
        ...
        /// <summary>
        ///     Exchanges the value of this <see cref="AtomicInteger" /> by with <paramref name="newValue" /> and returns the
        ///     original value.
        /// </summary>
        ...
        /// <summary>
        ///     Assigns a new value to the <see cref="AtomicInteger" /> if the current value is equal to a specified one, and
        ...
        /// <summary>
        ///     Creates a new instance of <see cref="AtomicInteger" /> from a provided <see cref="int" />.
        /// </summary>
        ...
        /// <summary>
        ///     Extracts a <see cref="int" /> from an instance of <see cref="AtomicInteger" />.
        /// </summary>
        ...
        {
            if (atomicInteger == null) throw new InvalidCastException();
