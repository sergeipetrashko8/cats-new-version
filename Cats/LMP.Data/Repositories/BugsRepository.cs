...
namespace LMP.Data.Repositories
{
    public class BugsRepository : RepositoryBase<LmPlatformModelsContext, Bug>, IBugsRepository
    {
        ...
        private List<Bug> GetPagebleSortedBugs(IQueryable<Bug> query, string sortedPropertyName, bool desc, int limit,
            int offset)
        {
        ...
        {
            return GetBugsQuery(context, searchString)
        ...
        private IQueryable<Bug> GetBugsQuery(LmPlatformModelsContext context, string searchString)
        {
            return context.Set<Bug>()
                ...
                .Where(e => searchString == null || e.Summary.Contains(searchString) ||
                            e.Project.Title.Contains(searchString) || e.Reporter.Student.LastName.Contains(searchString)
                );
        }
