    ...
    public class LmPlatformModelsContext : DbContext, IDpContext, ICpContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
                optionsBuilder.UseSqlServer(@"Server=tcp:bntu.database.windows.net,1433;
                                                            Initial Catalog=catsdb;Persist Security Info=False;
                                                            User ID=siarhei_piatrashka;Password=SeReGa54988;
